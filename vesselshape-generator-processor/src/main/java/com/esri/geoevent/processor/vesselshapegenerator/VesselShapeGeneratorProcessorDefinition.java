...
public class VesselShapeGeneratorProcessorDefinition extends
	...
	public VesselShapeGeneratorProcessorDefinition() throws PropertyException {
		try {
			...
			LabeledValue("${com.esri.geoevent.processor.vesselshape-generator-processor.SRC_GEOEVENT}","event"));
			allowedGeoSources.add(new
			LabeledValue("${com.esri.geoevent.processor.vesselshape-generator-processor.SRC_EVENT_DEF}","geodef"));
			allowedGeoSources.add(new
			LabeledValue("${com.esri.geoevent.processor.vesselshape-generator-processor.SRC_COORD_FIELDS}","coord"));
			
			PropertyDefinition procGeometrySource = new PropertyDefinition(
					"geosrc", PropertyType.String, "${com.esri.geoevent.processor.vesselshape-generator-processor.SRC_GEOEVENT}",
					"${com.esri.geoevent.processor.vesselshape-generator-processor.LBL_GEOMETRY_SRC}", "${com.esri.geoevent.processor.vesselshape-generator-processor.DESC_GEOMETRY_SRC}",
			...
			PropertyDefinition procXField = new PropertyDefinition("xfield",
					PropertyType.String, "longitude", "${com.esri.geoevent.processor.vesselshape-generator-processor.LBL_X_FIELD}",
					"${com.esri.geoevent.processor.vesselshape-generator-processor.DESC_X_FIELD}", false, false);
			...
			PropertyDefinition procYField = new PropertyDefinition("yfield",
					PropertyType.String, "latitude", "${com.esri.geoevent.processor.vesselshape-generator-processor.LBL_Y_FIELD}",
			...
			allowedSources.add(new
			LabeledValue("${com.esri.geoevent.processor.vesselshape-generator-processor.SRC_EVENT}","Event"));
			...
			PropertyDefinition procRangeSource = new PropertyDefinition(
							...
							"${com.esri.geoevent.processor.vesselshape-generator-processor.LBL_RANGE_SRC}", "${com.esri.geoevent.processor.vesselshape-generator-processor.DESC_RANGE_SRC}", true, false,
							allowedSources);		
			propertyDefinitions.put(procRangeSource.getPropertyName(),
					procRangeSource);

			PropertyDefinition procRange = new PropertyDefinition("range",
					PropertyType.Double, 1000, "${com.esri.geoevent.processor.vesselshape-generator-processor.LBL_RANGE}",
					"${com.esri.geoevent.processor.vesselshape-generator-processor.DESC_RANGE}", true, false);
			...
			PropertyDefinition procRangeEvent = new PropertyDefinition(
					...
					"${com.esri.geoevent.processor.vesselshape-generator-processor.LBL_RANGE_FIELD}",
					"${com.esri.geoevent.processor.vesselshape-generator-processor.DESC_RANGE_FIELD}", true, false);
			...
			LabeledValue("${com.esri.geoevent.processor.vesselshape-generator-processor.UNITS_METERS}","Meters"));
			unitsAllowedVals.add(new
			LabeledValue("${com.esri.geoevent.processor.vesselshape-generator-processor.UNITS_KM}","Kilometers"));
			unitsAllowedVals.add(new
			LabeledValue("${com.esri.geoevent.processor.vesselshape-generator-processor.UNITS_FT}","Feet"));
			unitsAllowedVals.add(new
			LabeledValue("${com.esri.geoevent.processor.vesselshape-generator-processor.UNITS_MILES}","Miles"));
			unitsAllowedVals.add(new
			LabeledValue("${com.esri.geoevent.processor.vesselshape-generator-processor.UNITS_NM}","Nautical Miles"));
			
			PropertyDefinition procUnits = new PropertyDefinition("units",
					PropertyType.String, "${com.esri.geoevent.processor.vesselshape-generator-processor.UNITS_METERS}", "${com.esri.geoevent.processor.vesselshape-generator-processor.LBL_UNITS}",
					"${com.esri.geoevent.processor.vesselshape-generator-processor.DESC_UNITS}", true, false, unitsAllowedVals);
			...
			PropertyDefinition procBearingSource = new PropertyDefinition(
					...
					PropertyType.String,
					"${com.esri.geoevent.processor.vesselshape-generator-processor.SRC_CONSTANT}",
					"${com.esri.geoevent.processor.vesselshape-generator-processor.LBL_BEARING_SRC}", "${com.esri.geoevent.processor.vesselshape-generator-processor.DESC_BEARING_SRC}", true, false,
					allowedSources);
			propertyDefinitions.put(procBearingSource.getPropertyName(),
					procBearingSource);

			PropertyDefinition procBearingC = new PropertyDefinition("bearing",
					PropertyType.Double, 0, "${com.esri.geoevent.processor.vesselshape-generator-processor.LBL_BEARING}", "${com.esri.geoevent.processor.vesselshape-generator-processor.DESC_BEARING}", true,
					false);
			...
			PropertyDefinition procBearingEvent = new PropertyDefinition(
					...
					"${com.esri.geoevent.processor.vesselshape-generator-processor.LBL_BEARING_FIELD}",
					"${com.esri.geoevent.processor.vesselshape-generator-processor.DESC_BEARING_FIELD}", true, false);
			...
			PropertyDefinition procWKIDBuffer = new PropertyDefinition(
					...
					"${com.esri.geoevent.processor.vesselshape-generator-processor.DESC_PROC_WKID}", true, false);
